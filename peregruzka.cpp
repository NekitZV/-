...
{   
    ...
    Account acc2 = acc; //êîíñòðóêòîð êîïèðîâàíèÿ
    Account* acc3 = new Account("Vasya", 12, 13, 14); //êîíñòðóêòîð èíèöèàëèçàöèè
    Account* acc4 = new Account(); //êîíñòðóêòîð ïî óìîë÷àíèþ
    Account acc5 = acc + acc2; //ïåðåãðóçêà
    cout << endl << endl << "Overloaded Object" << endl;
    acc5.Display();
    Account account_arr[3]; //ìàññèâ îáúåêòîâ
    account_arr[0] = acc;
    account_arr[1] = acc2;
}
